...
A curated list of awesome D frameworks, libraries and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 323,140 | 🐛 21 | 🌐 Python | 📅 2026-09-25.
...
* [DMD](https://github.com/dlang/dmd) ⭐ 3,312 | 🐛 3,801 | 🌐 D | 📅 2026-09-25 - The reference compiler for the D programming language. Stable, builds insanely fast, very good for learning and rapid prototyping/development. Currently the frontend is implemented in D, and shared between dmd, ldc and gdc, the backend is implemented in C++.
* [LDC](https://github.com/ldc-developers/ldc) ⭐ 1,371 | 🐛 584 | 🌐 D | 📅 2026-09-26 - The LLVM-based D compiler. Uses the DMD frontend and LLVM backend. Builds slower than dmd, but generates more optimized code than DMD. It supports all the target platforms of LLVM.
...
* [SDC](https://github.com/snazzy-d/SDC) ⭐ 273 | 🐛 95 | 🌐 D | 📅 2026-09-25 - The Snazzy D Compiler. Written in D. Grows Smarter every day.
...
* [arsd.script](https://github.com/adamdruppe/arsd/blob/master/script.d) ⭐ 567 | 🐛 53 | 🌐 D | 📅 2026-06-28 - A small script interpreter that builds on *arsd.jsvar* to be easily embedded inside and to have easy two-way interop with the host D program.
...
* [arsd](https://github.com/adamdruppe/arsd) ⭐ 567 | 🐛 53 | 🌐 D | 📅 2026-06-28 - Adam D. Ruppe's web framework. (See `arsd/cgi.d` for the CGI/FastCGI/SCGI/webserver component.)
...
* arsd [dom.d](https://github.com/adamdruppe/arsd/blob/master/dom.d) ⭐ 567 | 🐛 53 | 🌐 D | 📅 2026-06-28 - an xml/html DOM based on what Javascript provides in browsers
...
* [arsd](https://github.com/adamdruppe/arsd) ⭐ 567 | 🐛 53 | 🌐 D | 📅 2026-06-28 - Adam D. Ruppe's library; in addition to a Web backend, it also has support for database access with database.d, sqlite.d, mysql.d and postgres.d.
...
* [terminal.d](https://github.com/adamdruppe/arsd/blob/master/terminal.d) ⭐ 567 | 🐛 53 | 🌐 D | 📅 2026-06-28 - Part of Adam Ruppe's [arsd](https://github.com/adamdruppe/arsd) ⭐ 567 | 🐛 53 | 🌐 D | 📅 2026-06-28 library supporting cursor and color manipulation on the console.
...
* [onedrive](https://github.com/abraunegg/onedrive) ⭐ 12,853 | 🐛 20 | 🌐 D | 📅 2026-09-26 - #1 Free OneDrive Client for Linux.
...
* [minigui](https://arsd-official.dpldocs.info/arsd.minigui.html) - A smallish GUI widget library, aiming to be on par with at least HTML4 forms and a few other expected gui components. It's part of the [arsd libraries](https://github.com/adamdruppe/arsd/blob/master/minigui.d) ⭐ 567 | 🐛 53 | 🌐 D | 📅 2026-06-28.
...
* [Inochi Creator](https://github.com/Inochi2D/inochi-creator) ⭐ 1,226 | 🐛 144 | 🌐 D | 📅 2025-06-16 - Inochi2D Rigging Application.
...
* [PixmapPresenter](https://github.com/adamdruppe/arsd/blob/master/pixmappresenter.d) ⭐ 567 | 🐛 53 | 🌐 D | 📅 2026-06-28 - High-level display library for blitting fully-rendered frames to the screen (→ software-rendering, retro graphics).
...
* [arsd.ini](https://github.com/adamdruppe/arsd/blob/master/ini.d) ⭐ 567 | 🐛 53 | 🌐 D | 📅 2026-06-28 - A configurable INI parser with support for multiple “dialects” of the format.
...
* [arsd.di](https://github.com/adamdruppe/arsd/blob/master/di.d) ⭐ 567 | 🐛 53 | 🌐 D | 📅 2026-06-28 - A single-file lightweight dependency injection framework.
