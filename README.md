...
A curated list of awesome D frameworks, libraries and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 314,029 | 🐛 27 | 🌐 Python | 📅 2026-08-05.

Most documents and links are collected from the [D forum](https://forum.dlang.org), the [D wiki](https://wiki.dlang.org), and the [D package repository](https://code.dlang.org). Exploring GitHub is also helpful, as many libraries are hosted there. If you know of an interesting D project, please let us know via [GitHub issues](https://github.com/dlang-community/awesome-d/issues) ⭐ 764 | 🐛 3 | 🌐 D | 📅 2026-06-28 or by [editing this file](https://github.com/dlang-community/awesome-d/edit/master/README.md) ⭐ 764 | 🐛 3 | 🌐 D | 📅 2026-06-28.
...
* [Circular Studios](https://github.com/Circular-Studios) - We are a group of game developers at Rochester Institute of Technology building games and game tech. Hosts [Dash](https://github.com/Circular-Studios/Dash) ⭐ 423 | 🐛 32 | 🌐 D | 📅 2020-12-18, a 3D game engine written in D, and other related libs.
...
* [D Template Tutorial](https://github.com/PhilippeSigaud/D-templates-tutorial) ⭐ 236 | 🐛 11 | 🌐 HTML | 📅 2021-09-21 - A tutorial dedicated to D Templates. Very good explanation about templates. Has pdf version. by Philippe Sigaud.
...
* [dub](https://github.com/dlang/dub) ⭐ 734 | 🐛 538 | 🌐 D | 📅 2026-08-14 - Official package and build management system for D.

## Compilers

*Official compilers for the D language.*

* [DMD](https://github.com/dlang/dmd) ⭐ 3,300 | 🐛 3,845 | 🌐 D | 📅 2026-08-15 - The reference compiler for the D programming language. Stable, builds insanely fast, very good for learning and rapid prototyping/development. Currently the frontend is implemented in D, and shared between dmd, ldc and gdc, the backend is implemented in C++.
* [LDC](https://github.com/ldc-developers/ldc) ⭐ 1,362 | 🐛 581 | 🌐 D | 📅 2026-08-15 - The LLVM-based D compiler. Uses the DMD frontend and LLVM backend. Builds slower than dmd, but generates more optimized code than DMD. It supports all the target platforms of LLVM.
...
* [SDC](https://github.com/snazzy-d/SDC) ⭐ 273 | 🐛 95 | 🌐 D | 📅 2026-03-16 - The Snazzy D Compiler. Written in D. Grows Smarter every day.
...
* [D-Scanner](https://github.com/dlang-community/D-Scanner) ⭐ 256 | 🐛 130 | 🌐 D | 📅 2026-02-18 - Swiss-army knife for D source code (linting, static analysis, D code parsing, etc.)
* [dfmt](https://github.com/dlang-community/dfmt) ⭐ 218 | 🐛 106 | 🌐 D | 📅 2026-05-30 - formatter for D source code

## Build Tools

*Manage projects and compile software from source code.*

* [dub](https://github.com/dlang/dub) ⭐ 734 | 🐛 538 | 🌐 D | 📅 2026-08-14 - De facto official package and build management system for D. Will be included officially soon.
* [reggae](https://github.com/atilaneves/reggae) ⭐ 190 | 🐛 32 | 🌐 D | 📅 2026-06-12 - meta build system in D
...
* [DCD](https://github.com/dlang-community/DCD) ⭐ 362 | 🐛 63 | 🌐 D | 📅 2026-08-10 - Independent auto-complete program for the D programming language. Could be used with editors like vim, emacs, sublime text, textadept, and zeus. See [editors support](https://github.com/dlang-community/DCD/wiki/IDEs-and-Editors-with-DCD-support) ⭐ 362 | 🐛 63 | 🌐 D | 📅 2026-08-10.
* [Visual D](https://github.com/dlang/visuald) ⭐ 306 | 🐛 44 | 🌐 D | 📅 2026-07-26 - Visual Studio extension for the D programming language.
* [serve-d](https://github.com/Pure-D/serve-d) ⭐ 261 | 🐛 158 | 🌐 D | 📅 2026-07-19 - Language Server Protocol (LSP) implementation for D. Adds modern IDE features to any editor with LSP support (VSCode, Atom, Vim/Neovim and others)
...
* [Pegged](https://github.com/dlang-community/Pegged) ⭐ 550 | 🐛 67 | 🌐 D | 📅 2025-07-31 - A Parsing Expression Grammar (PEG) module written in D.
* [libdparse](https://github.com/dlang-community/libdparse) ⭐ 125 | 🐛 27 | 🌐 D | 📅 2026-05-10 - A D language lexer and parser, (possibly) future standard D parser/lexer.
* [ctpg](https://github.com/youxkei/ctpg) ⭐ 45 | 🐛 1 | 🌐 D | 📅 2015-05-06 - Compile-Time Parser (with converter) Generator written in D.
...
* [ldcup](https://github.com/kassane/ldcup) ⭐ 2 | 🐛 1 | 🌐 D | 📅 2026-06-22 - A small tool to install and manage LDC2 (LLVM backend) compiler.
...
* [unit-threaded](https://github.com/atilaneves/unit-threaded) ⭐ 122 | 🐛 4 | 🌐 D | 📅 2026-05-28 - Multi-threaded unit test framework
...
* [higgs](https://github.com/higgsjs/Higgs) ⭐ 883 | 🐛 17 | 🌐 JavaScript | 📅 2023-06-09 - Higgs JavaScript Virtual Machine, implemented in D.
* [arsd.script](https://github.com/adamdruppe/arsd/blob/master/script.d) ⭐ 566 | 🐛 53 | 🌐 D | 📅 2026-06-28 - A small script interpreter that builds on *arsd.jsvar* to be easily embedded inside and to have easy two-way interop with the host D program.
...
* [XOmB](https://github.com/xomboverlord/xomb) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2025-12-30 - An exokernel operating system written in D
...
* [dlib.container](https://github.com/gecko0307/dlib) ⭐ 226 | 🐛 4 | 🌐 D | 📅 2026-08-04 - generic data structures (GC-free dynamic and associative arrays and more)
* [EMSI containers](https://github.com/dlang-community/containers) ⭐ 112 | 🐛 14 | 🌐 D | 📅 2023-11-15 - Containers that do not use the GC
* [memutils](https://github.com/etcimon/memutils) ⭐ 45 | 🐛 3 | 🌐 D | 📅 2026-08-13 - Overhead allocators, allocator-aware containers and lifetime management for D objects
...
* [NuMem](https://github.com/Inochi2D/numem) ⭐ 37 | 🐛 0 | 🌐 D | 📅 2026-08-12 - No-GC memory management utilities for DLang.
* [Joka](https://github.com/Kapendev/joka) ⭐ 32 | 🐛 0 | 🌐 D | 📅 2026-08-09 - A nogc utility library.
* [NuLib](https://github.com/Inochi2D/nulib) ⭐ 15 | 🐛 3 | 🌐 D | 📅 2026-08-10 - D "standard" library built ontop of numem.

## Web Frameworks

*Networking libraries.*

* [dlang-requests](https://github.com/ikod/dlang-requests) ⭐ 159 | 🐛 10 | 🌐 D | 📅 2026-05-01 - HTTP client library inspired by python-requests
* [libasync](https://github.com/etcimon/libasync) ⭐ 148 | 🐛 5 | 🌐 D | 📅 2024-07-04 - Cross-platform event loop library of asynchronous objects
* [serverino](https://github.com/trikko/serverino) ⭐ 79 | 🐛 1 | 🌐 D | 📅 2026-05-21 - Small and ready-to-go http server, in D
...
* [arsd](https://github.com/adamdruppe/arsd) ⭐ 566 | 🐛 53 | 🌐 D | 📅 2026-06-28 - Adam D. Ruppe's web framework. (See `arsd/cgi.d` for the CGI/FastCGI/SCGI/webserver component.)
...
* [cerealed](https://github.com/atilaneves/cerealed) ⭐ 93 | 🐛 5 | 🌐 D | 📅 2026-05-14 - Serialisation library for D
...
* arsd [dom.d](https://github.com/adamdruppe/arsd/blob/master/dom.d) ⭐ 566 | 🐛 53 | 🌐 D | 📅 2026-06-28 - an xml/html DOM based on what Javascript provides in browsers
...
* [vibe.d](https://github.com/vibe-d/vibe.d) ⭐ 1,213 | 🐛 451 | 🌐 D | 📅 2026-07-04 - Vibe.d has internal support for Redis and MongoDB, which are very stable. Soon, the database drivers will be separated into independent projects.
* [arsd](https://github.com/adamdruppe/arsd) ⭐ 566 | 🐛 53 | 🌐 D | 📅 2026-06-28 - Adam D. Ruppe's library; in addition to a Web backend, it also has support for database access with database.d, sqlite.d, mysql.d and postgres.d.
...
* [d-colorize](https://code.dlang.org/packages/colorize) - A port of the ruby library [colorize](https://github.com/fazibear/colorize) ⭐ 1,283 | 🐛 4 | 🌐 Ruby | 📅 2024-05-21. It add some methods to set color, background color and text effect on console easier using ANSI escape sequences.
* [terminal.d](https://github.com/adamdruppe/arsd/blob/master/terminal.d) ⭐ 566 | 🐛 53 | 🌐 D | 📅 2026-06-28 - Part of Adam Ruppe's [arsd](https://github.com/adamdruppe/arsd) ⭐ 566 | 🐛 53 | 🌐 D | 📅 2026-06-28 library supporting cursor and color manipulation on the console.
...
* [onedrive](https://github.com/abraunegg/onedrive) ⭐ 12,690 | 🐛 24 | 🌐 D | 📅 2026-08-15 - #1 Free OneDrive Client for Linux.
* [Literate](https://github.com/zyedidia/Literate) ⭐ 913 | 🐛 36 | 🌐 D | 📅 2022-07-10 - A literate programming tool for any language.
* [tshare](https://github.com/trikko/tshare) ⭐ 141 | 🐛 0 | 🌐 D | 📅 2023-12-13 - Fast file sharing from cli, using transfer.sh.
* [Soulfind](https://github.com/soulfind-dev/soulfind) ⭐ 45 | 🐛 13 | 🌐 D | 📅 2026-08-12 - Soulseek server implementation in D.
* [todod](https://github.com/BlackEdder/todod) ⭐ 17 | 🐛 2 | 🌐 D | 📅 2017-03-22 - Todod is a command line based todo list manager. It also has support for shell interaction based on [linenoise](https://github.com/antirez/linenoise) ⭐ 4,335 | 🐛 154 | 🌐 C | 📅 2026-05-02.

## GUI Libraries

*Libraries for working with graphical user interface applications.*

* [DLangUI](https://github.com/buggins/dlangui) ⭐ 865 | 🐛 99 | 🌐 D | 📅 2026-04-05 - Cross Platform GUI for D programming language. My personal favorite, because it is written in D(not a binding), and is cross platform. DLangUI also has a good showcase in the IDE [DLangIDE](https://github.com/buggins/dlangide) ⭐ 490 | 🐛 127 | 🌐 D | 📅 2024-03-12.
* [minigui](https://arsd-official.dpldocs.info/arsd.minigui.html) - A smallish GUI widget library, aiming to be on par with at least HTML4 forms and a few other expected gui components. It's part of the [arsd libraries](https://github.com/adamdruppe/arsd/blob/master/minigui.d) ⭐ 566 | 🐛 53 | 🌐 D | 📅 2026-06-28.
...
* [tkD](https://github.com/nomad-software/tkd) ⭐ 118 | 🐛 7 | 🌐 D | 📅 2021-10-15 - GUI toolkit for the D programming language based on Tcl/Tk.
* [giD](https://github.com/Kymorphia/gid) ⭐ 43 | 🐛 5 | 🌐 D | 📅 2026-06-14 - GObject Introspection D Package Repository.
* [dqml](https://github.com/filcuc/dqml) ⭐ 42 | 🐛 3 | 🌐 D | 📅 2022-10-12 - Qt Qml bindings for the D programming language.
* [Sciter-Dport](https://github.com/sciter-sdk/Sciter-Dport) ⭐ 33 | 🐛 0 | 🌐 D | 📅 2017-06-12 - D bindings for the [Sciter](https://sciter.com) - crossplatform HTML/CSS/script desktop UI toolkit.
* [microui-d](https://github.com/Kapendev/microui-d) ⭐ 15 | 🐛 0 | 🌐 D | 📅 2026-03-20 - A tiny immediate-mode UI library.
...
* [tilix](https://github.com/gnunn1/tilix) ⭐ 5,713 | 🐛 454 | 🌐 D | 📅 2026-07-01 - A tiling terminal emulator for Linux using GTK+ 3.
* [Inochi Creator](https://github.com/Inochi2D/inochi-creator) ⭐ 1,196 | 🐛 139 | 🌐 D | 📅 2025-06-16 - Inochi2D Rigging Application.
* [Inochi Session](https://github.com/Inochi2D/inochi-session) ⭐ 400 | 🐛 25 | 🌐 D | 📅 2025-11-08 - Application that allows streaming with Inochi2D puppets.
...
* [sokol-d](https://github.com/floooh/sokol-d) ⭐ 28 | 🐛 2 | 🌐 C | 📅 2026-08-11 - D bindings for the sokol headers.
* [BindBC](https://github.com/BindBC) - Bindings compatible with `-betterC` and `@nogc`, using [bindbc-loader](https://github.com/BindBC/bindbc-loader) ⭐ 27 | 🐛 1 | 🌐 D | 📅 2025-01-28.
  * [SDL 2](https://github.com/BindBC/bindbc-sdl) ⭐ 130 | 🐛 2 | 🌐 D | 📅 2026-06-01 - Multimedia library
  * [Nuklear](https://github.com/Timu5/bindbc-nuklear) ⭐ 46 | 🐛 1 | 🌐 D | 📅 2023-09-22 - Immediate mode GUI
  * [OpenGL](https://github.com/BindBC/bindbc-opengl) ⭐ 42 | 🐛 0 | 🌐 D | 📅 2026-07-31 - Graphics API
  * [GLFW 3](https://github.com/BindBC/bindbc-glfw) ⭐ 42 | 🐛 0 | 🌐 D | 📅 2026-01-02 - Window/Input library
  * [WebGPU](https://github.com/DLangGamedev/bindbc-wgpu) ⭐ 33 | 🐛 1 | 🌐 C++ | 📅 2025-12-01 - Modern GPU API
  * [Imgui](https://github.com/Inochi2D/i2d-imgui) ⭐ 25 | 🐛 7 | 🌐 D | 📅 2025-10-22 - Immediate mode GUI
  ...
  * [HarfBuzz](https://github.com/DlangGraphicsWG/bindbc-harfbuzz) ⭐ 3 | 🐛 0 | 🌐 D | 📅 2024-11-19 - Text shaping
...
* [godot-math](https://github.com/AuburnSounds/godot-math) ⭐ 4 | 🐛 0 | 🌐 D | 📅 2026-06-10 - A D port of Godot's linear algebra with unchanged semantics.
...
* [PixmapPresenter](https://github.com/adamdruppe/arsd/blob/master/pixmappresenter.d) ⭐ 566 | 🐛 53 | 🌐 D | 📅 2026-06-28 - High-level display library for blitting fully-rendered frames to the screen (→ software-rendering, retro graphics).
* [HipremeEngine](https://github.com/MrcSnm/HipremeEngine) ⭐ 144 | 🐛 5 | 🌐 D | 📅 2026-07-31 - Cross Platform D-Lang Game Engine with scripting support.
* [PixelPerfectEngine](https://github.com/ZILtoid1991/pixelperfectengine) ⚠️ Archived - 2D graphics engine written in D.
* [Parin](https://github.com/Kapendev/parin) ⭐ 89 | 🐛 1 | 🌐 D | 📅 2026-08-09 - A delightfully simple 2D game engine.
...
* [Dagon](https://github.com/gecko0307/dagon) ⭐ 403 | 🐛 7 | 🌐 D | 📅 2026-08-14 - 3D game engine for D. See: <https://gecko0307.github.io/dagon/>
...
* [Electronvolt (formerly Atrium)](https://github.com/gecko0307/electronvolt) ⚠️ Archived - FPS game with physics based puzzles using OpenGL.
* [Backgammony](https://github.com/jonathanballs/backgammony) ⭐ 41 | 🐛 2 | 🌐 D | 📅 2024-06-19 - A Backgammon GUI for Linux built with Gtk.
...
* [Dtanks](https://github.com/kingsleyh/dtanks) ⭐ 12 | 🐛 0 | 🌐 C++ | 📅 2016-01-28 - Robot Tank Battle Game.
...
* [color.d](https://github.com/adamdruppe/arsd/blob/master/color.d) ⭐ 566 | 🐛 53 | 🌐 D | 📅 2026-06-28 + [bmp.d](https://github.com/adamdruppe/arsd/blob/master/bmp.d) ⭐ 566 | 🐛 53 | 🌐 D | 📅 2026-06-28, [jpg.d](https://github.com/adamdruppe/arsd/blob/master/jpg.d) ⭐ 566 | 🐛 53 | 🌐 D | 📅 2026-06-28, [png.d](https://github.com/adamdruppe/arsd/blob/master/png.d) ⭐ 566 | 🐛 53 | 🌐 D | 📅 2026-06-28 - basic color struct, HSL functions and reading and writing image files
* [PixmapPaint](https://github.com/adamdruppe/arsd/blob/master/pixmappaint.d) ⭐ 566 | 🐛 53 | 🌐 D | 📅 2026-06-28 - Pixmap image manipulation library for software-rendering purposes.
* [dlib.image](https://github.com/gecko0307/dlib) ⭐ 226 | 🐛 4 | 🌐 D | 📅 2026-08-04 - image processing (8 and 16 bits per channel, floating point operations, filtering, FFT, HDRI, graphics formats support including JPEG and PNG)
* [ArmageddonEngine](https://github.com/CyberShadow/ae/tree/master/utils/graphics) ⭐ 178 | 🐛 13 | 🌐 D | 📅 2026-08-06 - Vladimir Panteleev's ae library has a package for image processing in functional style, which is described in the article [Functional Image Processing in D](https://blog.cy.md/2014/03/21/functional-image-processing-in-d/).
* [opencvd](https://github.com/aferust/opencvd) ⭐ 23 | 🐛 1 | 🌐 D | 📅 2021-09-06 - Unofficial OpenCV binding for D

## Machine Learning

* [vectorflow](https://github.com/Netflix/vectorflow) ⭐ 1,294 | 🐛 15 | 🌐 D | 📅 2024-05-02 - Nexflix's opensource deep learning framework.
...
* [DCompute](https://github.com/libmir/dcompute) ⭐ 144 | 🐛 25 | 🌐 D | 📅 2026-07-19 - [GPGPU with Native D for OpenCL and CUDA](https://dlang.org/blog/2017/07/17/dcompute-gpgpu-with-native-d-for-opencl-and-cuda/)
...
* [mir-random](https://github.com/libmir/mir-random) ⭐ 32 | 🐛 2 | 🌐 D | 📅 2026-06-10 - Advanced Random Number Generators.
...
* [eBay's TSV utilities](https://github.com/eBay/tsv-utils/) ⭐ 1,482 | 🐛 24 | 🌐 D | 📅 2022-09-14 - Filtering, statistics, sampling, joins and other operations on TSV files. Very fast, especially good for large datasets.
...
* [arsd.ini](https://github.com/adamdruppe/arsd/blob/master/ini.d) ⭐ 566 | 🐛 53 | 🌐 D | 📅 2026-06-28 - A configurable INI parser with support for multiple “dialects” of the format.
* [sdlang](https://github.com/dlang-community/SDLang-D) ⭐ 125 | 🐛 34 | 🌐 D | 📅 2023-04-30 - An SDL (Simple Declarative Language) library for D.
...
* [adrdox](https://github.com/adamdruppe/adrdox) ⭐ 48 | 🐛 18 | 🌐 D | 📅 2026-06-23 - A documentation generator that can also be used for blogging. (Used by the *This Week in ARSD* blog.)
* [mood](https://github.com/mihails-strasuns/mood) ⭐ 45 | 🐛 6 | 🌐 D | 📅 2020-11-20 - simple vibe.d based blog engine

## Dependency Injection

*Apply inversion of control.*

* [arsd.di](https://github.com/adamdruppe/arsd/blob/master/di.d) ⭐ 566 | 🐛 53 | 🌐 D | 📅 2026-06-28 - A single-file lightweight dependency injection framework.
...
* [Botan](https://github.com/etcimon/botan) ⭐ 91 | 🐛 7 | 🌐 D | 📅 2026-08-13 - Block & stream ciphers, public key crypto, hashing, KDF, MAC, PKCS, TLS, ASN.1, BER/DER, etc.
* [OpenSSL](https://github.com/D-Programming-Deimos/openssl) ⭐ 47 | 🐛 12 | 🌐 C | 📅 2025-08-26 - D version of the C headers for OpenSSL.
...
* [Hunt Framework](https://github.com/huntlabs/hunt-framework/) ⭐ 300 | 🐛 22 | 🌐 D | 📅 2024-03-11 - Hunt is a high-level D Programming Language Web framework that encourages rapid development and clean, pragmatic design. It lets you build high-performance Web applications quickly and easily.
* [DWT](https://github.com/d-widget-toolkit/dwt) ⭐ 139 | 🐛 13 | 🌐 D | 📅 2026-05-02 - A library for creating cross-platform GUI applications. GWT is a port of the Java SWT library to D. DWT was promoted as a semi-standard GUI library for D, but unfortunately didn't catch up popularity yet.
...
* [LibUI](https://github.com/Extrawurst/DerelictLibui) ⭐ 33 | 🐛 4 | 🌐 D | 📅 2021-05-28 - Dynamic Binding for [libui](https://github.com/andlabs/libui) ⭐ 10,893 | 🐛 249 | 🌐 C | 📅 2024-05-29
